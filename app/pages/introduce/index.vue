  ...
  <div>
    ...
    <UContainer class="pt-10 pb-0">
      ...
      <div class="text-center mb-12">
        <h2 class="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4" v-html="introduce.title" />
      ...
      <div class="flex flex-col lg:flex-row gap-12 items-center mb-16">
        ...
        <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
          <CardItem v-for="benefit in introduce.benefits" :key="benefit.title" :item="benefit" />
        </div>
    ...
    <div class="bg-primary py-10 mb-16">
      <UContainer>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div v-for="metric in introduce.metrics" :key="metric.value" class="text-center text-white">
            <UIcon :name="metric.icon" class="size-8 mx-auto mb-2 opacity-90" />
            <p class="text-3xl md:text-4xl font-extrabold mb-1">{{ metric.value }}</p>
            <p class="text-sm font-medium opacity-90">{{ metric.label }}</p>
          </div>
        </div>
      </UContainer>
    </div>
    ...
    <UContainer class="pb-10">
      ...
      <div class="grid md:grid-cols-3 gap-6 mb-16">
        <CardItem v-for="coreValue in introduce.coreValues" :key="coreValue.title" :item="coreValue" />
      </div>
      ...
      <div class="grid lg:grid-cols-2 gap-14 items-center mb-16">
        ...
        <div>
          ...
          <div class="flex flex-col gap-3">
            <SharedFeatureList v-for="reason in introduce.reasons" :key="reason" :feature="reason" />
          </div>
        </div>
